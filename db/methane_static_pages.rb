...
<span class="line"></span>
    ...
    <div id="content">
        ...
        <div class="middle">
          ...
          <div class="right">
            ...
            <ul>
              ...
              <li>The economic, resource scarcity or geopolitical drivers associated with their evaluation as a possible source of natural gas, </li>
              <li>The environmental and societal impacts of possible development</li>
            </ul>
          </div>
        </div>
      ...
      <div id="body_content_left">
        ...
        <div class="member">
          <div class="head">
            <div id="what_are_methane" class="top first"></div>
            <div class="middle">
              <h2>What are methane gas hydrates?</h2>
              <span class="line"></span>
            </div>
          </div>
          ...
          <div class="middle">
            <p>Scott Dallimore, Research Scientist with the Geological Survey of Canada providing insights on methane gas hydrates as part of the UNEP Global Outlook on Methane Gas Hydrates project.</p>
          </div>
          <div class="bottom">
            <a onclick="javascript:void $.scrollTo('div#header',400)">Back to top</a>
          </div>
        </div>
</div>
 <div id="body_content_right">
    <div id="about_right_column">
        <div class="about_right">
          <div class="top"></div>
          <div class="middle">
            <div class="head">
              <h3>Expert videos</h3>
              <p>From our knowledge center</p>
              <span class="line"></span>
            </div>
            <ul>
              <li><a onclick="javascript:void $.scrollTo('div#what_are_methane',400)">What are methane gas hydrates?</a>
</li>
              <li><a onclick="javascript:void $.scrollTo('div#what_are_potential',400)">What are the potential societal impacts of methane gas hydrates development?</a>
</li>
              <li><a onclick="javascript:void $.scrollTo('div#how_does_global',400)">How does global warming effect gas hydrates stability?</a>
</li>
              <li><a onclick="javascript:void $.scrollTo('div#how_are_methane',400)">How are methane gas hydrates a potential source of energy?</a>
</li>
              <li><a onclick="javascript:void $.scrollTo('div#how_can_methane',400)">How can methane gas hydrates contribute to the energy mix of the future?</a>
</li>
              <li><a onclick="javascript:void $.scrollTo('div#why_did_choose',400)">Why did you choose to study methane gas hydrates?</a>
</li>
            </ul>
          </div>
          <div class="bottom"></div>
...
<div id="body_content_left">
        ...
        <div class="member">
          <div class="head">
            <div id="what_are_potential" class="top"></div>
            <div class="middle">
              <h2>What are the potential societal impacts of methane gas hydrate development?</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle image">
          ...
          <div class="middle">
            <p>Kelly Rose, Geologist with the U.S. National Energy Technology Laboratory providing insights on methane gas hydrates as part of the UNEP Global Outlook on Methane Gas Hydrates project.</p>
          </div>
          <div class="bottom">
        ...
        <div class="member">
          <div class="head">
            <div id="how_does_global" class="top"></div>
            <div class="middle">
              <h2>How does global warming effect gas hydrates stability?</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle image">
          ...
          <div class="middle">
            <p>Tina Treude, Biological Oceanographer from IFM-GEOMAR providing insights on methane gas hydrates as part of the UNEP Global Outlook on Methane Gas Hydrates project.</p>
          </div>
          <div class="bottom">
            <a onclick="javascript:void $.scrollTo('div#header',400)" id="back_to_top">Back to top</a>
          </div>
        ...
        <div class="member">
          <div class="head">
            <div id="how_are_methane" class="top"></div>
            <div class="middle">
              <h2>How are methane gas hydrates a potential source of energy?</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle image">
        ...
        <div class="member">
          <div class="head">
            <div id="how_can_methane" class="top"></div>
            <div class="middle">
              <h2>How can methane gas hydrates contribute to the energy mix of the future?</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle image">
          ...
          <div class="middle">
            <p>Klaus Wallmann, Marine Geoscientist from IFM-GEOMAR providing insights on methane gas hydrates as part of the UNEP Global Outlook on Methane Gas Hydrates project.</p>
          </div>
          <div class="bottom">
            <a onclick="javascript:void $.scrollTo('div#header',400)" id="back_to_top">Back to top</a>
          </div>
        ...
        <div class="member">
          <div class="head">
            ...
            <div class="middle">
              <h2>Why did you choose to study methane gas hydrates?</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle image">
          ...
          <div class="middle">
            <p>William Waite, Research Geophysicist with the U.S. Geological Survey providing insights on methane gas hydrates as part of the UNEP Global Outlook on Methane Gas Hydrates project.</p>
          </div>
          <div class="bottom">
            <a onclick="javascript:void $.scrollTo('div#header',400)" id="back_to_top">Back to top</a>
          </div>
...
<li><a onclick="javascript:void $.scrollTo('h3#can_hydrate_development',400)">Can hydrate development cause tsunamis?</a>
        ...
        <div class="faq_block">
          <div class="head_faq">
            <div class="top"></div>
            <div class="middle">
              <h2>Methane gas hydrates as potential sources of energy</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle">
        ...
        <div class="faq_block">
          <div class="head_faq">
            <div class="top"></div>
            <div class="middle">
              <h2>Explotation &amp; commercialization</h2>
              <span class="line"></span>
            </div>
          </div>
          <div class="middle">
...
<div class="title">
  <div class="inner_title">
    <div class="left">
        ...
        <p>An effort of The United Nations Environment Program and UNEP/GRID-Arendal</p>
    </div>
    <div class="right">
      <ul>
        <li class="selected"><a href="/about">ABOUT THE PROJECT</a>
...
<li class="first">
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        ...
        <p class="subtitle"><a href="http://folk.uib.no/nglbh/GANS/index.html" target="_blank">http://folk.uib.no/nglbh/GANS/index.html</a>
</p>
        <p>The main aim of GANS is to quantify gas accumulations in the 1) form of hydrates in sediments on the Norway - Barents Sea - Svalbard (NBS) margin; including an assessment of their dynamics and impacts on the seabed, and 2) their response on sediments and biota, to provide knowledge vital for a safe exploitation in oil and gas production. The overall objective is to make a coordinated effort on a national level to achieve the main objective by the following sub-goals:</p>
        <ul>
          <li>Geophysical characterization of gas hydrates</li>
          <li>Geological and geochemical setting of gas hydrate reservoirs and seeps</li>
          <li>Gas hydrate dissociation and its effects on geomechanical properties</li>
          <li>Theoretical and experimental evaluation of gas hydrate dynamics</li>
        </ul>
      </div>
    </div>
    <div class="bottom"></div>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        ...
        <p class="subtitle"><a href="http://www.gfz-potsdam.de/" target="_blank">http://www.gfz-potsdam.de/</a>
</p>
        <p>The mass of organic carbon in sedimentary basins amounts to a staggering 1016 tons, dwarfing the mass contained in coal, oil, gas and all living systems by ten thousand-fold. The changing fate of this giant mass during subsidence and uplift, via chemical, physical and biological processes, is known to ultimately control fossil energy resource occurrence worldwide. But what has been overlooked and/or ignored until now is its enormous capacity for driving global climate: only a tiny degree of leakage, particularly when focussed through the clathrate cycle, can result in high greenhouse gas emissions, both in the present as well as in the geologic past.<br /><br />Understanding the workings of sedimentary basins in time and space is fundamental to gaining insights into Earth’s climate.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        <h2>IFM-GEOMAR</h2>
        <p class="subtitle"><a href="http://www.ifm-geomar.de/" target="_blank">http://www.ifm-geomar.de/</a>
</p>
        <p>The Leibniz Institute of Marine Sciences at the University of Kiel (IFM-GEOMAR) was founded in January 2004 through the merger of the Institut für Meereskunde (IfM) and the Research Center for Marine Geosciences (GEOMAR). The institute is a member of the Leibniz-foundation and employs approximately 500 scientific and technical staff. The institutes’ mandate is the interdisciplinary investigation of all relevant aspects of modern marine sciences, from seafloor geology to marine meteorology. Research is conducted worldwide in all oceans. The institute has four major research divisions: ocean circulation and climate dynamics, marine biogeochemistry, marine ecology and the dynamics of the ocean floor.<br />
        The Leibniz Institute of Marine Sciences is associated with the University of Kiel in undergraduate and graduate teaching in the following fields: oceanography, meteorology, biological oceanography, fisheries biology, marine chemistry and geology. Basic research on marine gas hydrates has a long tradition at IFM-GEOMAR. Recently a new national program on applied gas hydrate research has been launched at the institute to develop environmentally acceptable technologies for gas hydrate exploitation.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        <h2>JOGMEC</h2>
        <p class="subtitle"><a href="http://www.jogmec.go.jp/english/index.html" target="_blank">http://www.jogmec.go.jp/english/index.html</a>
</p>
        <p>Japan Oil, Gas and Metals National Corporation (JOGMEC) was established on February 29, 2004 pursuant to the Law Concerning the Japan Oil, Gas and Metals National Corporation, which was promulgated on July 26, 2002. JOGMEC integrates the functions of the former Japan National Oil Corporation, which was in charge of securing a stable supply of oil and natural gas, and the former Metal Mining Agency of Japan, which was in charge of ensuring a stable supply of nonferrous metal and mineral resources and implementing mine pollution control measures.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        <h2>NETL</h2>
        <p class="subtitle"><a href="http://www.netl.doe.gov/" target="_blank">http://www.netl.doe.gov/</a>
</p>
        <p>The National Energy Technology Laboratory (NETL), part of DOE’s national laboratory system, is owned and operated by the U.S. Department of Energy (DOE). NETL supports DOE’s mission to advance the national, economic, and energy security of the United States.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        <h2>Schlumberger</h2>
        <p class="subtitle"><a href="http://www.slb.com/" target="_blank">http://www.slb.com/</a>
</p>
        <p>Schlumberger is the leading oilfield services provider, trusted to deliver superior results and improved E&amp;P performance for oil and gas companies around the world. Through our well site operations and in our research and engineering facilities, we are working to develop products, services and solutions that optimize customer performance in a safe and environmentally sound manner.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        <h2>Statoil</h2>
        <p class="subtitle"><a href="http://www.statoil.com/" target="_blank">http://www.statoil.com/</a>
</p>
        <p>Statoil is an international energy company with operations in 40 countries. Building on more than 35 years of experience from oil and gas production on the Norwegian continental shelf, we are committed to accommodating the world’s energy needs in a responsible manner, applying technology and creating innovative business solutions.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        <h2>USGS</h2>
        <p class="subtitle"><a href="http://energy.usgs.gov/other/gashydrates/" target="_blank">http://energy.usgs.gov/other/gashydrates/</a>
</p>
        <p>The USGS serves the Nation by providing reliable scientific information to describe and understand the Earth; minimize loss of life and property from natural disasters; manage water, biological, energy, and mineral resources; and enhance and protect our quality of life.<br /><br />
        USGS has become a world leader in the natural sciences thanks to our scientific excellence and responsiveness to society’s needs.</p>
      </div>
    </div>
    <div class="bottom"></div>
  </li>
  ...
  <li>
    ...
    <div class="middle">
      ...
      <div class="right">
        ...
        <p class="subtitle"><a href="http://www.dghindia.org/" target="_blank">http://www.dghindia.org/</a>
</p>
...
puts " - partners"
partners = Page.create(:title => "Partners",
            :link_url => "/partners",
            :menu_match => "^/(partners).*$",
            :deletable => false,
            :position => -1)
partners.parts.create({
              :title => "Body",
              :body => html,
              :position => 0
})
